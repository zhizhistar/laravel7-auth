...
<body style="padding: 10px">
    <form class="layui-form">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                @if ($group['status'] == 0)
                <input type="checkbox" title="禁用" value="0"  lay-skin="primary" class="layui-input" name="status">
                @else
                <input type="checkbox" title="禁用" value="-1" checked  lay-skin="primary" class="layui-input" name="status">
                @endif
            </div>
        </div>
    ...
    <script>
        ...
        layui.use(['form','jquery','layer','authtree'],function(){
            ...
            //  ajax获取远程权限表
            $.get('/group/edit?gid={{$group["gid"]}}',function(res){
                var data = res.data;
                console.log(data);

...
<head>
    ...
    <link rel="icon" href="/plugins/layuimini-2/images/favicon.ico">
    <link rel="stylesheet" href="/plugins/layuimini-2/lib/layui-v2.5.5/css/layui.css" media="all">
    <link rel="stylesheet" href="/plugins/layuimini-2/css/layuimini.css?v=2.0.4.2" media="all">
    <link rel="stylesheet" href="/plugins/layuimini-2/css/themes/default.css" media="all">
...
<script src="/plugins/layuimini-2/js/lay-config.js?v=2.0.0" charset="utf-8"></script>
<script>
    layui.use(['jquery', 'layer', 'miniAdmin','miniTongji'], function () {
        ...
        var options = {
            iniUrl: "/manager/init_menu",    // 初始化接口
        ...
        $('.login-out').on("click", function () {
            $.get('/account/logout',function(res){
                if(res.code < 0){
                    return layer.alert('退出失败',{icon:2});
                }
                layer.msg(res.msg);

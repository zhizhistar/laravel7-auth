...
<div class="layui-form layuimini-form">
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <input type="text" name="name" lay-verify="required" lay-reqtext="管理员名称不能为空" placeholder="请输入管理员名称" value="" class="layui-input">
        </div>
    </div>
    <div class="layui-form-item">
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <input type="text" placeholder="请输入登陆密码"  class="layui-input" name="password">
        </div>
    </div>
    <div class="layui-form-item">
        <label class="layui-form-label">邮箱号码</label>
        <div class="layui-input-block">
            <input type="email" placeholder="请输入邮箱号码" class="layui-input" name="email">
        </div>
    </div>
...
<script>
    ...
    function save()
    {
        ...
        if(password == ''){
            return layer.alert('登陆密码不能为空',{icon:2});
        }
        if(email == ''){

...
<div class="layui-form layuimini-form">
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <input type="text" name="title" value="{{$menu['title']}}" lay-verify="required" lay-reqtext="菜单名称不能为空" placeholder="请输入菜单名称" value="" class="layui-input">
        </div>
    </div>
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
          <select class="pid" name="pid" lay-verify="required">
            ...
            @foreach ($menus as $item)
                <option value="{{$item['mid']}}" {{$menu['pid'] == $item['mid'] ? 'selected':''}}>{{$item['title']}}</option>
            @endforeach
          </select>
        </div>
      </div>
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            @if ($menu['ishidden'] == 0)
            <input type="checkbox" checked title="显示菜单" lay-skin="primary" class="layui-input" name="ishidden">
            @else
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            ...
            @else
            <input type="checkbox"  title="禁用" checked lay-skin="primary" class="layui-input" name="status">
            @endif
        </div>
    </div>
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <input type="text" name="controller" placeholder="请输入控制器名称" value="{{$menu['controller']}}" class="layui-input">
        </div>
    </div>
    <div class="layui-form-item">
        <label class="layui-form-label">方法</label>
        <div class="layui-input-block">
            <input type="text" name="action" placeholder="请输入方法名称" value="{{$menu['action']}}" class="layui-input">
        </div>
    </div>
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <input type="text" name="icon" placeholder="请输入菜单图标" value="{{$menu['icon']}}" class="layui-input">
        </div>
    </div>
    <div class="layui-form-item">
        <label class="layui-form-label">打开方式</label>
        <div class="layui-input-block">
            <input type="text" name="target" placeholder="请输入打开方式" value="{{$menu['target']}}" class="layui-input">
        </div>
    </div>
